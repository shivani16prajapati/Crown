...
<aui:form action="<%= editEntryURL %>" enctype="multipart/form-data" method="post" name="fm" onSubmit="event.preventDefault();">
	...
	<aui:fieldset>
	  <div class="ust-blog-form-box01">
		<aui:input autoFocus="<%= windowState.equals(WindowState.MAXIMIZED) %>" name="title" cssClass="ust-form-box01-form01" showRequiredLabel="<%=false %>" label="" placeholder="Blog Title" />
	</div>
...
<style>
.ust-blog-form-box01{ width:100%; margin:0 auto; padding:12px 0%; position:relative; }
</style>
<aui:script>
