...
public interface SprintService extends GenericService<Sprint, Long>{
	...
	public List<Sprint> getSprintListBySolutionIdAndSolutionScrumId(long solutionId, long groupId);

	public List<Sprint> getListofSolutionSprint(long start, int recordsSize,String fieldname, String orderBy, long solutionId,long solutionScrumId);
