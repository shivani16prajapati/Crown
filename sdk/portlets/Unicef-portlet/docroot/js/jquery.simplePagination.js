/**
 * simplePagination.js v1.6 A simple jQuery pagination plugin.
 * http://flaviusmatis.github.com/simplePagination.js/
 * 
 * Copyright 2012, Flavius Matis Released under the MIT license.
...
(function($) {
	...
	var methods = {
		init : function(options) {
			...
			this.each(function() {
				self.addClass(o.cssStyle + ' simple-pagination').data(
						'pagination', o);
		...
		updateItems : function(newItems) {
			var o = this.data('pagination');
			o.items = newItems;
			o.pages = Math.ceil(o.items / o.itemsOnPage) ? Math.ceil(o.items
					/ o.itemsOnPage) : 1;
			this.data('pagination', o);
			methods._draw.call(this);
		},
		...
		_draw : function() {
			...
			var $panel = this.prop("tagName") === "UL" ? this : $('<ul></ul>')
					.appendTo(this);
			...
			if (interval.start > 0 && o.edges > 0) {
				...
				if (o.edges < interval.start && (interval.start - o.edges != 1)) {
					$panel.append('<li class="disabled"><span class="ellipse">'
							+ o.ellipseText + '</span></li>');
		...
		_appendItem : function(pageIndex, opts) {
			var self = this, options, $link, o = self.data('pagination'), $linkWrapper = $('<li></li>'), $ul = self
					.find('ul');
			...
			if (pageIndex == o.currentPage || o.disabled) {
				...
				$link = $('<a href="' + o.hrefTextPrefix + (pageIndex + 1)
						+ o.hrefTextSuffix + '" class="page-link">'
						+ (options.text) + '</a>');
